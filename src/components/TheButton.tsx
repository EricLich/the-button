...
const TheButton: React.FC<TheButtonProps> = ({
  ...
  return (
    <button
      ...
      } w-[150px] md:w-[200px] h-[60px] md:min-h-[100px] rounded-xl md:rounded-3xl shadow-2xl text-2xl md:text-5xl hover:bg-[url('/src/assets/imgs/never-gonna.gif')] hover:bg-cover hover:bg-center`}
    >
      {clock.remainingSecs}
    </button>
  );
